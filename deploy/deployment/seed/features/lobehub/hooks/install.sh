...
DEFAULT_IMAGE_TAG="lobehub/lobehub:1.56.2"
...
services:
  lobehub:
    image: lobehub/lobehub:1.56.2
    container_name: sc-lobehub-${NODE_ID}
...
# 占位 .env（lobehub）：真实 Secret 由控制面注入
